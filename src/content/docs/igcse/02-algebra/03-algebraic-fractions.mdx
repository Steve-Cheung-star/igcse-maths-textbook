...
<AIGenerator course="IGCSE" storageKey="igcse_math_history" topic="Simplifying rational algebraic expressions using index laws, factorising quadratics, and DOTS" difficulty="IGCSE Extended" client:load />
...
<AIGenerator course="IGCSE" storageKey="igcse_math_history" topic="Multiplying and dividing simple algebraic fractions" difficulty="IGCSE Core" client:load />
...
<AIGenerator course="IGCSE" storageKey="igcse_math_history" topic="Adding and subtracting algebraic fractions with numerical denominators" difficulty="IGCSE Core" client:load />
...
<AIGenerator course="IGCSE" storageKey="igcse_math_history" topic="Adding and subtracting algebraic fractions with binomial denominators" difficulty="IGCSE Extended" client:load />
...
<AIGenerator course="IGCSE" storageKey="igcse_math_history" topic="Adding and subtracting algebraic fractions by factoring denominators to find the LCM" difficulty="IGCSE Extended" client:load />