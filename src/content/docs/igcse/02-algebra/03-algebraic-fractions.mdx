...
<SmartAIGenerator topic="Simplifying rational algebraic expressions using index laws, factorising quadratics, and DOTS" />
...
<SmartAIGenerator topic="Multiplying and dividing simple algebraic fractions" />
...
<SmartAIGenerator topic="Adding and subtracting algebraic fractions with numerical denominators" />
...
<SmartAIGenerator topic="Adding and subtracting algebraic fractions with binomial denominators" />
...
<SmartAIGenerator topic="Adding and subtracting algebraic fractions by factoring denominators to find the LCM" />