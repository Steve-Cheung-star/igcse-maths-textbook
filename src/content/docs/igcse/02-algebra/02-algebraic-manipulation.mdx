...
<SmartAIGenerator topic="Simplifying algebraic expressions by collecting like terms" />
...
<SmartAIGenerator topic="Expanding single, double, and triple algebraic brackets" />
...
<SmartAIGenerator topic="Factorising algebraic expressions by grouping 4 terms" />
...
<SmartAIGenerator topic="Factorising using the difference of two squares, including extracting a common factor first" />
...
<SmartAIGenerator topic="Factorising monic quadratics using the sum and product method" />
...
<SmartAIGenerator topic="Factorising non-monic quadratics using the AC method or cross method" />
...
<SmartAIGenerator topic="Factorising complex algebraic expressions including cubics and negatives by extracting a common factor first" />