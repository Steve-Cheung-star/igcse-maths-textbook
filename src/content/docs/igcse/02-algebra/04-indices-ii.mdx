...
<AIGenerator course="IGCSE" storageKey="igcse_math_history" topic="Evaluating numerical expressions with zero, negative, and fractional indices" difficulty="IGCSE Extended" client:load />
...
<AIGenerator course="IGCSE" storageKey="igcse_math_history" topic="Simplifying complex algebraic expressions involving negative and fractional indices" difficulty="IGCSE Extended" client:load />
...
<AIGenerator course="IGCSE" storageKey="igcse_math_history" topic="Solving exponential equations by equating bases" difficulty="IGCSE Extended" client:load />