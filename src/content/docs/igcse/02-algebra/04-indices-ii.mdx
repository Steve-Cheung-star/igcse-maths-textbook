...
<SmartAIGenerator topic="Evaluating numerical expressions with zero, negative, and fractional indices" />
...
<SmartAIGenerator topic="Simplifying complex algebraic expressions involving negative and fractional indices" />
...
<SmartAIGenerator topic="Solving exponential equations by equating bases" />