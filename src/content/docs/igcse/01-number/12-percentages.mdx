...
<SmartAIGenerator topic="Percentage of amounts and adding tax/VAT" />
...
<SmartAIGenerator topic="Expressing one quantity as a percentage of another and calculating percentage profit/loss" />
...
<SmartAIGenerator topic="Chained percentage increases and decreases" />
...
<SmartAIGenerator topic="Finding the single overall percentage change from chained multipliers" />
...
<SmartAIGenerator topic="Calculating simple interest and total amounts" />
...
<SmartAIGenerator topic="Calculating compound interest and comparing it with simple interest" />
...
<SmartAIGenerator topic="Calculating depreciation and inflation over multiple years" />
...
<SmartAIGenerator topic="Finding unknown compound interest rates using nth roots" />
...
<SmartAIGenerator topic="Finding unknown time periods using trial and improvement" />
...
<SmartAIGenerator topic="Finding unknown depreciation rates using roots" />
...
<SmartAIGenerator topic="Reverse percentages, finding original price before pay rises or added tax" />
...
<SmartAIGenerator topic="Reverse percentages for discounts and depreciation" />
