...
<AIGenerator course="IGCSE" storageKey="igcse_math_history" topic="Percentage of amounts and adding tax/VAT" difficulty="IGCSE Core" client:load />
...
<AIGenerator course="IGCSE" storageKey="igcse_math_history" topic="Expressing one quantity as a percentage of another and calculating percentage profit/loss" difficulty="IGCSE Core" client:load />
...
<AIGenerator course="IGCSE" storageKey="igcse_math_history" topic="Chained percentage increases and decreases" difficulty="IGCSE Extended" client:load />
...
<AIGenerator course="IGCSE" storageKey="igcse_math_history" topic="Finding the single overall percentage change from chained multipliers" difficulty="IGCSE Extended" client:load />
...
<AIGenerator course="IGCSE" storageKey="igcse_math_history" topic="Calculating simple interest and total amounts" difficulty="IGCSE Core" client:load />
...
<AIGenerator course="IGCSE" storageKey="igcse_math_history" topic="Calculating compound interest and comparing it with simple interest" difficulty="IGCSE Core/Extended" client:load />
...
<AIGenerator course="IGCSE" storageKey="igcse_math_history" topic="Calculating depreciation and inflation over multiple years" difficulty="IGCSE Core/Extended" client:load />
...
<AIGenerator course="IGCSE" storageKey="igcse_math_history" topic="Finding unknown compound interest rates using nth roots" difficulty="IGCSE Extended" client:load />
...
<AIGenerator course="IGCSE" storageKey="igcse_math_history" topic="Finding unknown time periods using trial and improvement" difficulty="IGCSE Extended" client:load />
...
<AIGenerator course="IGCSE" storageKey="igcse_math_history" topic="Finding unknown depreciation rates using roots" difficulty="IGCSE Extended" client:load />
...
<AIGenerator course="IGCSE" storageKey="igcse_math_history" topic="Reverse percentages, finding original price before pay rises or added tax" difficulty="IGCSE Extended" client:load />
...
<AIGenerator course="IGCSE" storageKey="igcse_math_history" topic="Reverse percentages for discounts and depreciation" difficulty="IGCSE Extended" client:load />
