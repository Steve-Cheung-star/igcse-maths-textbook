...
<SmartAIGenerator topic="Identifying number types: natural, integer, rational, irrational, prime, square" />
...
<SmartAIGenerator topic="Converting large numbers from words to digits and place value" />
...
<SmartAIGenerator topic="Expressing a number as a product of its prime factors in index form" />
...
<SmartAIGenerator topic="Finding the HCF and LCM of two basic 2-digit numbers" />
...
<SmartAIGenerator topic="Finding the HCF and LCM of larger 2-digit numbers using prime factorisation" />
...
<SmartAIGenerator topic="Finding the HCF and LCM of numbers given in prime factor index form" />
...
<SmartAIGenerator topic="Finding missing exponents in prime factorisation when given the HCF and LCM" />